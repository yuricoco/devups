...
class CountryController extends Controller{
    ...
    public function listView($next = 1, $per_page = 10){
        ...
        self::$jsfiles[] = Country::classpath('Ressource/js/countryCtrl.js');
    ...
    public function datatable($next, $per_page) {
        ...
        return ['success' => true,
            'datatable' => CountryTable::init(new Country())->buildindextable()->getTableRest(),
        ];
    ...
    public function createAction($country_form = null ){
        ...
        return 	array(	'success' => true,
                        'country' => $country,
                        'tablerow' => CountryTable::init()->buildindextable()->getSingleRowRest($country),
                        'detail' => '');
