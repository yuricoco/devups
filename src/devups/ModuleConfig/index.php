...
switch (Request::get('path')) {
    ...
    case 'layout':
        ...
        $datatablemodule = Dvups_moduleTable::init(new Dvups_module())->buildindextable();
        $datatableentity = Dvups_entityTable::init(new Dvups_entity())->buildindextable();

        Genesis::renderView("admin.overview", compact("datatableentity", "datatablemodule"));
        break;
