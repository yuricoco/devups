<?php 
	...
	class Dvups_roleDAO extends DBAL{
		...
		public function create(Dvups_role $dvups_role) {
			parent::__construct($dvups_role);
		...
		public function update(Dvups_role $dvups_role) {
			parent::__construct($dvups_role);
		...
		public function findById($id) {
			...
			$dvups_role->setId($id);
			parent::__construct($dvups_role);
			if($instanceDvups_role = parent::findByIdDbal()){
				return $instanceDvups_role;
			}else {
				return null;
			}
		}
		
		public function delete(Dvups_role $dvups_role) {
			parent::__construct($dvups_role);
