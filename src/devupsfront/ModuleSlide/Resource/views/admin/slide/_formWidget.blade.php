...
<div class='form-group'>
    ...
    <?= Form::radio('activated', ["unactive", "activate"], $slide->getActivated(), ['class' => 'form-control']); ?>
</div>
...
<button hidden type="button" class="btn btn-info hidden" onclick='slide.submit(this)'>{{t('Enregistrer')}}</button>
