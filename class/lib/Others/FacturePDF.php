<?php
    ...
    class FacturePDF extends FPDF{
        ...
        public function facturePDFinit($atextAdr1='', $atextAdr2='', $aFooter=''){

                $this->SetMargins(0, 0, 0);
                $this->SetFont('Helvetica', '', 11);
                $this->AliasNbPages();//definir un alias pour le nombre de page
                $this->template = array();
        ...
        public function setLogo($aUrl='', $aWidth=15, $aX=10, $aY=6){
                $this->logoUrl = $aUrl;
                $this->logoPosX = $aX;
                $this->logoPosY = $aY;
