...
----------------------------------------------------- */
$(".owl-carousel.related_pro_single").owlCarousel({
...
/*---------------------------------------------------
     Product Slider (with owl-carousel)
-----------------------------------------------------
 , .owl-carousel.related_pro */
$(".owl-carousel.product_carousel, .owl-carousel.latest_category_carousel, .owl-carousel.latest_brands_carousel").owlCarousel({
...
$(".owl-carousel.store_carousel").owlCarousel({
