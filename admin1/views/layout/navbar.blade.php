...
//                                if(is_object($module)){?>
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href='<?= path( 'src/'. strtolower($module["module"]->getProject()) .'/'. $module["module"]->getName() . '/index.php?path=' . strtolower($entity->getName()) .'/index') ?>' >
                                            <?= $entity->getLabel() ?> | gérer <span class="fa fa-angle-right"></span>
                                        </a>
                                    </li>
                                    <?php }?>
                                </ul>
